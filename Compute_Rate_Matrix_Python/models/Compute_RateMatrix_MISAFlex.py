...
def MISA_Flex_Rxn(parameters):
    ...
    Rxn['Parameters'] = np.array([g_a,g_b,g_c,g_d,ha,hr,hr,ha,fa,fr,fa,fr,kd,g_a,g_b,g_c,g_d,ha,hr,hr,ha,fa,fr,fa,fr,kd])
...
def main(inputs):
    Rxn, A, B, NumStates, NumSpec, NumRxn, GeneA_States, GeneB_States = MISA_Flex_Rxn(inputs)
