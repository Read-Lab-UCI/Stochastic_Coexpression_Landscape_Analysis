...
if __name__ == "__main__":
    ...
    productionMatrix = np.array([[1e-3, 2.0, 1e-3, 1e-3, 1e-3, 2.0, 1e-3, 1e-3],
                                 [1e-3, 2.0, 1e-3, 1e-3, 1e-3, 4.0, 1e-3, 1e-3],
                                 [1e-3, 2.0, 1e-3, 1e-3, 1e-3, 7.0, 1e-3, 1e-3],
                                 [1e-3, 4.0, 1e-3, 1e-3, 1e-3, 2.0, 1e-3, 1e-3],
                                 [1e-3, 4.0, 1e-3, 1e-3, 1e-3, 4.0, 1e-3, 1e-3],
                                 [1e-3, 4.0, 1e-3, 1e-3, 1e-3, 7.0, 1e-3, 1e-3],
                                 [1e-3, 7.0, 1e-3, 1e-3, 1e-3, 2.0, 1e-3, 1e-3],
                                 [1e-3, 7.0, 1e-3, 1e-3, 1e-3, 4.0, 1e-3, 1e-3],
                                 [1e-3, 7.0, 1e-3, 1e-3, 1e-3, 7.0, 1e-3, 1e-3]])

    # Creating binding variation portion
    bindingRateValues = [1e0, 1e1, 1e2, 1e3, 1e4, 1e5, 1e6]
