function [ ModelName, RateMatrix ] = Compute_RateMatrix_MISAEx_Act( paramSetNum, parameters, trialFolder)
...
Model='MISAEx_Act'; % Used for filenames 
N=parameters('N');
g0=parameters('g0');
g1=parameters('g1');
kd=parameters('kd');
...
Parameters=[g1;g1;g0;ha;hr;fa;fr;kd;g1;g1;g0;ha;hr;fa;fr;kd];
